...
//  הערכים חייבים להיות בדיוק הטקסט שברשימה של הטופס. בחניה האפשרות
//  נקראת "חניה" בלבד — לא "חניה - רכב חברה" כמו בדלק — וההנחה שהשם
//  בנוי באותה תבנית עצרה את המילוי על כל קבלת חניה.
export const FORM_EXPENSE_OPTIONS = [
  'חניה', 'תדלוק - רכב חברה', 'רחיצת רכב חברה', 'תיקון צמיג/דרך - רכב חברה',
  'אירוח בארץ', 'אירוח מחו"ל',
];
